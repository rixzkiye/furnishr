...
const products: Product[] = [
  {
    ...
    images: [
      { url: 'https://images.pexels.com/photos/1080696/pexels-photo-1080696.jpeg', hint: 'armchair living room' },
      { url: 'https://images.pexels.com/photos/1080696/pexels-photo-1080696.jpeg', hint: 'armchair side view' },
      { url: 'https://images.pexels.com/photos/1080696/pexels-photo-1080696.jpeg', hint: 'armchair fabric detail' },
    ],
    specifications: {
  ...
  },
  {
    ...
    images: [
      { url: 'https://images.pexels.com/photos/1129413/pexels-photo-1129413.jpeg', hint: 'coffee table minimalist' },
      { url: 'https://images.pexels.com/photos/1129413/pexels-photo-1129413.jpeg', hint: 'coffee table top down' },
    ],
    specifications: {
      'Material': 'Mango Wood',
  ...
  },
  {
    ...
    images: [
      { url: 'https://images.pexels.com/photos/534172/pexels-photo-534172.jpeg', hint: 'velvet sofa' },
      { url: 'https://images.pexels.com/photos/534172/pexels-photo-534172.jpeg', hint: 'sofa side profile' },
      { url: 'https://images.pexels.com/photos/534172/pexels-photo-534172.jpeg', hint: 'sofa cushion texture' },
    ],
    specifications: {
  ...
  },
  {
    ...
    images: [
      { url: 'https://images.pexels.com/photos/90319/pexels-photo-90319.jpeg', hint: 'floor lamp' },
      { url: 'https://images.pexels.com/photos/90319/pexels-photo-90319.jpeg', hint: 'lamp base detail' },
    ],
    specifications: {
  ...
  },
  {
    ...
    images: [
      { url: 'https://images.pexels.com/photos/3097112/pexels-photo-3097112.jpeg', hint: 'dining chair' },
      { url: 'https://images.pexels.com/photos/3097112/pexels-photo-3097112.jpeg', hint: 'chair pair' },
    ],
    specifications: {
      'Material': 'Beech Wood',
  ...
  },
  {
    ...
    images: [
      { url: 'https://images.pexels.com/photos/313776/pexels-photo-313776.jpeg', hint: 'console table rustic' },
      { url: 'https://images.pexels.com/photos/313776/pexels-photo-313776.jpeg', hint: 'table drawer open' },
    ],
    specifications: {
  ...
  },
  {
    ...
    images: [
      { url: 'https://images.pexels.com/photos/2079249/pexels-photo-2079249.jpeg', hint: 'leather sofa' },
      { url: 'https://images.pexels.com/photos/2079249/pexels-photo-2079249.jpeg', hint: 'chesterfield sofa detail' },
    ],
    specifications: {
  ...
  },
  {
    ...
    images: [
      { url: 'https://images.pexels.com/photos/2079249/pexels-photo-2079249.jpeg', hint: 'pendant light industrial' },
      { url: 'https://images.pexels.com/photos/2079249/pexels-photo-2079249.jpeg', hint: 'pendant light hanging' },
    ],
    specifications: {
      'Material': 'Spun Steel',
  ...
  {
    id: '9',
    slug: 'industrial-pendant-light-2',
    name: 'Industrial Pendant Light',
    category: 'Lighting',
    price: 95.00,
    description: 'This industrial-style pendant light is perfect for kitchens and dining areas. The metal shade directs light downwards, creating focused illumination. Its simple, functional design adds a modern, urban edge to any room.',
    images: [
      { url: 'https://images.pexels.com/photos/269252/pexels-photo-269252.jpeg', hint: 'pendant light industrial' },
      { url: 'https://images.pexels.com/photos/269252/pexels-photo-269252.jpeg', hint: 'pendant light hanging' },
    ],
    specifications: {
      'Material': 'Spun Steel',
      'Dimensions': '10" H x 12" Diameter Shade',
